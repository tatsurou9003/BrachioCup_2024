        ...
        child: Row( // フッター内のコンテンツを横並びに配置
          ...
          children: <Widget>[
            ...
            IconButton( 
              ...
              onPressed: () {
                // ボタンが押されたときの処理
                Navigator.push(context, MaterialPageRoute(builder: (context) => Detail(0, ['https://vegmet-bucket.s3.ap-northeast-1.amazonaws.com/salad.jpg'], ['tasty soup'], ['tomato,cucumber,eggplant'], ['salt, pepper, and so on. veggie veggie bbbbbbbbbbbbbbbbbbbbbbbb. '])),);
              },
            ),
          ],
        ),
