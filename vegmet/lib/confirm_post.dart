...
//     Future<void> addToRecipes(String inputName,String selectedItem, String selectedItem2, String selectedItem3, String _selectedMainOrSide, String _selectedHotOrCold, String createdDescription) async {
//       setState(() {
//         _isLoading = true;
//       });
//       String _createdDescription;
//       final String sendData = selectedItem + ',' + selectedItem2 + ',' + selectedItem3 + ',' + _selectedMainOrSide + ',' + _selectedHotOrCold;
//       try{
//         Response response = await Dio().post(
//           // 'https://e9nrzw97x4.execute-api.ap-northeast-1.amazonaws.com/dev/vegmet/home',
//           'https://e9nrzw97x4.execute-api.ap-northeast-1.amazonaws.com/dev/vegmet/order',
...
class ConfirmPost extends StatefulWidget {
  ...
  @override
  _ConfirmPostState createState() => _ConfirmPostState(inputName: inputName, selectedItem: selectedItem, selectedItem2: selectedItem2, selectedItem3: selectedItem3, selectedMainOrSide: selectedMainOrSide, selectedHotOrCold: selectedHotOrCold, createdDescription: createdDescription);
}
...
class _ConfirmPostState extends State<ConfirmPost> {
  ...
  String? selectedMainOrSide;
  String? selectedHotOrCold;
  String? createdDescription;

  _ConfirmPostState({this.inputName, this.selectedItem, this.selectedItem2, this.selectedItem3, this.selectedMainOrSide, this.selectedHotOrCold, this.createdDescription});
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> addToRecipes(String inputName,String selectedItem, String selectedItem2, String selectedItem3, String selectedMainOrSide, String selectedHotOrCold, String createdDescription) async {
      setState(() {
        _isLoading = true;
      });
      String _createdDescription;
      // final String sendData = selectedItem + ',' + selectedItem2 + ',' + selectedItem3 + ',' + selectedMainOrSide + ',' + selectedHotOrCold;
      final String sendData = selectedItem + ',' + selectedItem2 + ',' + selectedItem3;
      
      // String recipeImage = "https://vegmet-bucket.s3.ap-northeast-1.amazonaws.com/salad.jpg";

      print('sendData:           $sendData');
      print('createdDescription: $createdDescription');
      try{
        Response response = await Dio().post(
          'https://e9nrzw97x4.execute-api.ap-northeast-1.amazonaws.com/dev/vegmet/order/add',
          data: {
            "ingredients": sendData,
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        // addToRecipes(inputName, String selectedItem, String selectedItem2, String selectedItem3, String selectedMainOrSide, String selectedHotOrCold, String createdDescription)
                        addToRecipes(
                            inputName ?? '',
                            selectedItem ?? '',
                            selectedItem2 ?? '',
